...
- ### The beta-binomial model
	...
	- #### Bernoulli likelihood
	    ...
	    1. - 각 시행의 결과를 나타내는 변수 ��yn​은 베르누이 분포를 따릅니다.
		    - 각 시행의 확률을 나타내는 파라미터는 �θ로 표현됩니다.
		    - 데이터셋 �D에서 나온 모든 결과를 곱한 우도 함수는 다음과 같습니다.
		
		$p(D|\theta)=\Pi_{n=1}^{N}​θ^{y_n}​(1−θ)1−yn$​
		
		- 여기서 �N은 전체 시행 횟수이고, �1N1​은 앞면이 나온 횟수, �0N0​은 뒷면이 나온 횟수입니다.
