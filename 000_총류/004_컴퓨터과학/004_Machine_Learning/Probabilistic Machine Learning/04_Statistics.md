...
- ### Cross-validation
	...
	- **해결방안:**
		...
		- #### The one standard error rule
			다음으로, 각 예제 $n$에 대한 손실을 $L_n​=l(y_n​,f(x_n​;\hat{θ}_{λ}(D−n​)))$로 정의하고, $\hat{μ}=\frac{1}{N}\sum_{n=1}^{N}​L_n$​를 추정된 평균으로 정의합니다. 그리고 $\hat{σ}^2​=\frac{1}{N​∑n=1N​(Ln​−μ∧)2$를 추정된 분산으로 정의합니다. 이때, �∧σ∧는 ��Ln​의 표본 간 고유한 가변성을 측정하고, se(�∧)=�∧�se(μ∧)=Nσ∧​​는 평균 �∧μ∧에 대한 불확실성을 나타냅니다.
